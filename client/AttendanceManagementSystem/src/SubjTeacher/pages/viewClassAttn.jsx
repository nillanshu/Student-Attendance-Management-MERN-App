...
const ViewClassAttn = () => {
  ...
  const location = {
    ...
    route: '/SubjectTeacher/viewClassAttendance'
  };
  ...
  const columns = [
    ...
    {
      name: 'Term',
      selector: row => row.tblsessionterm.tblterm && row.tblsessionterm.tblterm.termName,
      sortable: false,
      cell: row => <div className='cell' title={row.tblsessionterm.tblterm && row.tblsessionterm.tblterm.termName}>{row.tblsessionterm.tblterm && row.tblsessionterm.tblterm.termName}</div>
    }
  ];
